    ...
    <div className='text-black bg-gradient-to-l from-cyan-500 to-blue-500'>
      <div className='m-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
        ...
        <div className='flex justify-center'>
          <h1 className='md:text-7xl sm:text-5xl text-5xl font-bold md'>i am a</h1>
          <ReactTyped className='md:text-7xl sm:text-4xl text-5xl font-bold pl-2 md:pl-4' strings={['designer.', 'developer.', 'drone pilot.']} typeSpeed={70} backSpeed={40} loop />
        </div>
      </div>
    </div>
  );
